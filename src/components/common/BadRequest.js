        ...
        return (
            <div>
                <div className="d-flex  align-items-center" style={{ height: "30vh", marginLeft: 200 }} >
                    <h1 className="mr-3 pr-3 align-top border-right inline-block align-content-center">400</h1>
                    <div className="inline-block align-middle">
                        <h2 className="font-weight-normal lead" id="desc">Yanlış istekte bulunduznuz.</h2>
